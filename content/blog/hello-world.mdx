...
_please note, as of 4/13/2023 vercel [cron jobs](https://vercel.com/docs/cron-jobs) feature is still in beta mode and has limitations based on the type of plan you have (Hobby, Pro, etc..)_
...
![Vercel Cron Job Limitations](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/7ku95b90jg7fw7lbzafn.png)
...
**path** is the location of the folder we created in step #2. **schedule** is telling vercel how often the cron job should run. `*/10 * * * *` is running the cronjob about every 10 minutes. You can play around with different schedules using [crontab guru](https://crontab.guru/#*/10_*_*_*_*).
...
![Vercel Cron Jobs Menu](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/puindxr6qly7jqu0l2cb.png)
