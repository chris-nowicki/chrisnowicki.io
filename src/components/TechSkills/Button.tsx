...
export default function Button({ name, data, activeCheck, handleClick }) {
    ...
    return (
        <button
            className={`text-sm md:text-md rounded border border-neutral-200 p-2 hover:bg-neutral-100 dark:border-gray-900 dark:text-textDark dark:hover:bg-gray-900/25 ${
                isActive ?
