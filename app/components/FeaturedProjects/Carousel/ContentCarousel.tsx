...
export default function ContentCarousel({ contents }) {
  ...
  return (
    <>
      <div className="relative flex w-full flex-col rounded-bl rounded-br border-l border-r border-b border-borderColor-light p-2 shadow-lg dark:border-borderColor-dark md:p-4">
