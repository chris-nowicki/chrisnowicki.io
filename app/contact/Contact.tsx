export default function Contact() {
  return (
    <div
      id="contact"
      className="flex w-full flex-col items-center justify-center rounded bg-background-light px-8 py-8 text-foreground shadow-lg shadow-background-light/50 dark:bg-background-dark dark:shadow-background-dark/50 md:px-16"
    >
      <div className="flex flex-col items-center">
        ...
        <p className="text-center text-lg">
          ...
          about an opportunity, or ask me a question! My inbox is always open.
        </p>
        <a
